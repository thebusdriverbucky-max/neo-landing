...
export default async function TermsOfServicePage() {
  ...
  const text = content.legal?.termsOfService || "Terms of Service content is not available.";
  ...
  return (
    <main className="min-h-screen bg-primary text-white flex flex-col">
      <div className="flex-grow container-custom max-w-4xl py-20 md:py-32">
        ...
        <h1 className="text-4xl md:text-5xl font-serif font-bold mb-12 tracking-tight">Terms of Service</h1>
